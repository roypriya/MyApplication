...
public class Toucing extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ViewPager viewPager;
    Adapter adapter;
    List<Model> models;
    Integer[] colors=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toucing);
        ...
        description.add("I do not touch my friends and teacher too much");
        description.add("I use my words and tell them how I feel");
        description.add("Too much touching and kissing makes people upset");
        description.add("It makes people happy when I use my words, and do not touch");
